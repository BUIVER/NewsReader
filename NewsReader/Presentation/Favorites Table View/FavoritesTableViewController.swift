...
class FavoritesTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.fetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: self.managedContext, sectionNameKeyPath: nil, cacheName: nil) as? NSFetchedResultsController<NSFetchRequestResult>
    ...
    @IBAction func addFavoriteAction(_ sender: Any) {
        ...
        let addFavoriteAction = UIAlertAction(title: "Add", style: .default, handler: { (action: UIAlertAction!) in
            ...
            let favorite = NSEntityDescription.insertNewObject(forEntityName: "Favorite", into: self.managedContext) as! Favorite
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let favorite = fetchedResultsController.object(at: indexPath) as! Favorite
